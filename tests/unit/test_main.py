...
def app_instance():
    with (
        patch("dica.core.app.ObjectDetector"),
        ...
        patch("dica.core.app.threading.Thread"),
    ):
        app = App()
        return app
...
def test_ai_task_loop(app_instance):
    ...
    app_instance.detector.consolidate_max_count.return_value = [
        {"class_name": "nasi_porsi", "harga": 5000}
    ]
