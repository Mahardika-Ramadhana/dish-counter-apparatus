...
- ⬜ 1.2 Elaborasi Embedded System (software stack, threading, headless daemon) — 5 SP
- ⬜ 1.3 Elaborasi IoT distributif (narasi + diagram arsitektur multi-cabang) — 8 SP
- ⬜ 1.4 Sinkronisasi konsistensi antar-bab (Bab D merefleksikan arsitektur Headless BYOD) — 5 SP
...
- ✅ 2.6 Optimasi waktu inferensi agar transaksi < 5 detik konsisten (via Headless Snapshot) — 3 SP
...
- 🚫 5.3 [DIBATALKAN] Pasang LCD 5" TFT sungguhan (Diganti arsitektur Headless BYOD via HP) — 0 SP
...
- Load cell & kamera fisik asli terpasang dan terkalibrasi (Tanpa layar fisik, 100% Headless via HP)
- Minimal 1 kali sync data lokal → cloud berhasil dibuktikan (Selesai malam ini!)
